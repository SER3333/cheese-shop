...
const seoMap = {
  siry: {
    title: "Купити крафтовий сир — натуральні сири без хімії",
    description: "Купити крафтовий фермерський сир: Белпер. Доставка по Україні.",
    h1: "Купити крафтовий сир",
    subtitles: [
      "Купити сир Белпер",
      // "Тверді та мʼякі фермерські сири"
    ],
    text: "У нашій крафтовій лавці ви можете купити крафтовий сир з натурального фермерського молока. Ми пропонуємо тільки фермерські сири без хімії, консервантів та штучних добавок з доставкою по всій Україні.",
  },
  ...
  dzhemy: {
    ...
    subtitles: [
      "Домашні ягідні та фруктові джеми",
    ],
  ...
  soky: {
    ...
    subtitles: [
      "Соки прямого віджиму з фермерських фруктів",
    ],
  ...
  default: {
    title:
      "Крафтова лавка — купити крафтові продукти онлайн. Крафтові сири, джеми, соки",
    description:
    ...
    subtitles: [
      "Крафтові сири, натуральні джеми та соки",
    ],
...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-yellow-50">
      ...
      {/* SEO TEXT BLOCK */}
      <section className="max-w-4xl mx-auto px-4 my-8 text-center">
        ...
        {/* Підзаголовки */}
        {seo.subtitles && seo.subtitles.length > 0 && (
          <div className="flex flex-col gap-2 mb-4">
            {seo.subtitles.map((subtitle, idx) => (
              <h2
                key={idx}
                className="text-lg md:text-xl font-semibold text-yellow-700"
              >
                {subtitle}
              </h2>
            ))}

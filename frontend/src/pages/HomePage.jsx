...
const seoMap = {
  ...
  default: {
    title:
      "Крафтова лавка — купити крафтові продукти | Сири, джеми, соки",
    description:
      "Купити крафтові продукти: крафтові сири без хімії, натуральні джеми та соки прямого віджиму. Доставка по Україні.",
    h1: "Купити крафтові продукти",
    text:
      "Ми пропонуємо купити крафтові продукти напряму від виробника: крафтові сири, натуральні джеми та соки без консервантів.",
  },
};
